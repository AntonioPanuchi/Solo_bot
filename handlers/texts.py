...
PAYMENT_OPTIONS = [{'text': f'{price} RUB', 'callback_data': f'amount|{price}'} for price in RENEWAL_PRICES.values()]  #устар.
...
# Тексты профилей
def profile_message_send(username, tg_id, balance_txt, key_count):
    if CHANNEL_EXISTS:
        profile_message = (
            f"👤 <b>Профиль: {username}</b>\n\n"
            f"<blockquote>"
            f"—— <b>ID:</b> <code>{tg_id}</code>\n"
            f"—— <b>Баланс:</b> {balance_txt}\n"
            f"—— <b>К-во подписок:</b> {key_count}\n"
            f"</blockquote>\n"
...
PAYMENT_SUCCESS_MESSAGE = "Ваш баланс успешно пополнен на {amount} .{cashback_text} Спасибо за оплату!"
...
DEFAULT_PAYMENT_MESSAGE = "Вы выбрали пополнение на {amount} . Перейдите по ссылке для оплаты:"
...
WATA_RU_DESCRIPTION = "💳 Оплата через WATA (карты РФ). Быстрое и безопасное пополнение баланса."
WATA_SBP_DESCRIPTION = "🏦 Оплата через WATA (СБП). Моментальное зачисление через Систему Быстрых Платежей."
WATA_INT_DESCRIPTION = "🌍 Оплата через WATA (международные карты). Для пользователей за пределами РФ."

WATA_PAYMENT_MESSAGE = "Вы выбрали пополнение на {amount} рублей через WATA. Перейдите по ссылке для оплаты:"
WATA_PAYMENT_TITLE = "Пополнение баланса через WATA"
WATA_PAYMENT_SUCCESS = "Ваш баланс успешно пополнен через WATA на {amount} руб. Спасибо за оплату!"
WATA_PAYMENT_DECLINED = "❌ Оплата через WATA не прошла. Попробуйте другой способ или обратитесь в поддержку."
WATA_PAYMENT_PENDING = "⏳ Ожидание подтверждения оплаты через WATA..."
WATA_PAYMENT_ERROR = "Произошла ошибка при создании платежа через WATA. Попробуйте позже."

FAST_PAY_NOT_ENOUGH = "💳 Для оплаты не хватает {amount}"
FAST_PAY_CHOOSE_CURRENCY = "Выберите валюту платежа:"
FAST_PAY_CHOOSE_PROVIDER = "Выберите платёжную систему:"

# KassaAI
KASSAI_CARDS_DESCRIPTION = "💳 Оплата картами РФ через KassaAI"
KASSAI_SBP_DESCRIPTION = "🏦 Оплата через СБП (Система быстрых платежей) KassaAI"
KASSAI_PAYMENT_MESSAGE = "💰 К оплате: {amount} ₽\n\n🔗 Нажмите кнопку \"Оплатить\" для перехода к оплате"
KASSAI_PAYMENT_TITLE = "Пополнение баланса VPN"

# Heleket
HELEKET_CRYPTO_DESCRIPTION = "₿ Оплата криптовалютами через Heleket"
HELEKET_PAYMENT_MESSAGE = "💰 К оплате: {amount} \n\n₿ Оплата криптовалютой через Heleket\n🔗 Нажмите кнопку \"Оплатить\" для перехода к оплате"
HELEKET_PAYMENT_TITLE = "Пополнение баланса VPN"
...
SUBSCRIPTION_INFO_TEXT = "📄 Подписка: {email} — {time_left}"
HAPP_ANNOUNCE = "↖️Бот | {subscription_info} | Поддержка↗️"
V2RAYTUN_ANNOUNCE = "🔑 Выберите сервер ⬇️ | 💬 Поддержка ➡️"
HIDDIFY_PROFILE_TITLE = "{project_name}\n📄 Подписка: {key_info}"
KEYS_HEADER = "<b>🔑 Список ваших подписок:</b>\n\n<blockquote>"
KEYS_FOOTER = "</blockquote>\n\n<i>Нажмите на ✏️, чтобы переименовать подписку.</i>"
RENAME_KEY_PROMPT = "✏️ Введите новое имя подписки (до 10 символов):"
DAYS_LEFT_MESSAGE = "<b>🕒 Статус подписки:</b>\n🔴 Истекла"
SELECT_SUBS = "Выберите подписку для продления или купите новую"
...
def key_message_success(connection_link, tariff_name: str = "", traffic_limit: int = 0, device_limit: int = 0, subgroup_title: str = ""):
    key_message = (
        "✅ Подписка успешно создана: 🎉\n\n"
        f"<code>{connection_link}</code>\n\n"
    )
    tariff_lines = []
    if subgroup_title and subgroup_title.strip():
        tariff_lines.append(f"📁 Группа: {subgroup_title}")
    if tariff_name:
...
def key_message(
    ...
    if tariff_lines:
        response_message += "📦 Тариф подписки:" + "<blockquote>" + "\n".join(tariff_lines) + "\n</blockquote>\n"
...
def get_renewal_message(tariff_name: str = "", traffic_limit: int = 0, device_limit: int = 0, expiry_date: str = "", subgroup_title: str = "") -> str:
...
INVITE_MESSAGE_TEMPLATE = (
    ...
    "🤝 <i>Приглашайте друзей и получайте крутые бонусы на каждом уровне! 💰</i>\n\n"
    "🏆 <b>Бонусы за приглашения:</b>\n"
    "<blockquote>{bonuses_block}\n</blockquote>\n"
    "📊 <b>Статистика приглашений:</b>\n"
    "👥 Всего приглашено: {total_referrals} человек\n\n"
    "📈 <b>Детальная статистика по уровням:</b>\n"
    "<blockquote>{details_block}\n</blockquote>\n"
    "💰 <b>Общий бонус от рефералов:</b> {total_referral_bonus}"
)
...
SHARE_TEXT_TEMPLATE_NOT_INLINE = (
    "🎁 Дарю тебе VPN на {months_text}!\n\n"
    "📅 Доступно до: {expiry_time}\n\n"
    "🔗 Чтобы получить, перейди по этой ссылке: {gift_link}"
)

def get_gift_confirmation_text(duration_text: str, price: int) -> str:
    return (
        f"<b>Подтверждение подарка:</b>\n"
        f"Подписка на <b>{duration_text}</b>\n"
